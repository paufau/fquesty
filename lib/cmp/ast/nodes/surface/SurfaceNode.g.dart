...
part of 'SurfaceNode.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SurfaceNode _$SurfaceNodeFromJson(Map<String, dynamic> json) => SurfaceNode(
      label: json['label'] as String,
      zIndex: (json['zIndex'] as num).toDouble(),
      singleSprite: json['singleSprite'] as bool?,
    )..type = $enumDecode(_$ENodeTypeEnumMap, json['type']);

Map<String, dynamic> _$SurfaceNodeToJson(SurfaceNode instance) =>
    <String, dynamic>{
      'type': _$ENodeTypeEnumMap[instance.type],
      'label': instance.label,
      'zIndex': instance.zIndex,
      'singleSprite': instance.singleSprite,
    };
